    ...
    return [
        {
            ...
            "function": {
                ...
                "description": (
                    ...
                    "for imported route-based runs, walks, hikes, and rides), "
                    "and 'sleep_all' (all sleep "
                    ...
                    "location, session trends), 'workout_split' for within-run pacing, "
                    "per-km heart rate and cardiac drift, and contiguous PR "
                    "segments, and 'daily' for day-level health "
                    "metrics (HRV, resting HR, steps, recovery, mobility, "
                    "overnight respiratory rate and wrist temperature). See "
