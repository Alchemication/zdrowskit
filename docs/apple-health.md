...
- Nights the watch was not worn arrive as zero-hour sleep entries. They are skipped on import, so an untracked night is stored as missing rather than as a night without sleep.
