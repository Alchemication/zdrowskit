...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| chat | gpt-5.6-luna (high) | 11/11 | 81.8% | 90.9% | 2 | 3 | 7.24s | $0.0184 | b1fac38 | 2026-08-09 |
| insights | gpt-5.6-luna (high) | 3/3 | 33.3% | 66.7% | 2 | 3 | 17.63s | $0.0148 | b1fac38 | 2026-08-09 |
| memory | gpt-5.6-luna | 3/3 | 100.0% | 100.0% | 0 | 3 | 1.18s | $0.0007 | b1fac38 | 2026-08-09 |
| nudge | gpt-5.6-luna (high) | 6/6 | 83.3% | 94.4% | 1 | 3 | 4.84s | $0.0087 | b1fac38 | 2026-08-09 |
| verification_judge | deepseek-v4-flash (high) | 7/7 | 85.7% | 90.5% | 1 | 3 | 71.15s | $0.0170 | b1fac38 | 2026-08-09 |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| **production routes** | production | 3 | 11/11 | 81.8% | 90.9% | 2 | 7.24s | $0.0184 | b1fac38 | `chat_log_entry_token_format` 2/3<br>`chat_tempo_short_warmup_negative` 1/3 |
...
- `chat_log_entry_token_format` 2/3 FLAKY — entry_stands_alone_without_the_conversation
- `chat_tempo_short_warmup_negative` 1/3 FLAKY — treats_shortened_session_as_not_meeting_the_prescription
...
| **production routes** | production | 3 | 3/3 | 33.3% | 66.7% | 2 | 17.63s | $0.0148 | b1fac38 | `insights_does_not_contradict_the_stated_hrv_trend` 1/3<br>`insights_fits_a_phone_notification_w31` 2/3 |
...
| **production routes** | production | 3 | 3/3 | 100.0% | 100.0% | 0 | 1.18s | $0.0007 | b1fac38 | - |
...
| **production routes** | production | 3 | 6/6 | 83.3% | 94.4% | 1 | 4.84s | $0.0087 | b1fac38 | `nudge_week_totals_match_logged_workouts_w21` 2/3 |
...
| Model | Reasoning | Repeat | Cases | Strict | Attempt | Flaky | Avg Latency | Cost/run | Revision | Failing |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| deepseek-v4-flash | high | 5 | 7/7 | 85.7% | 97.1% | 1 | 62.77s | $0.0239 | c015036* (stale) | `verification_judge_insights_unsupported_vo2max_recency_w15` 4/5 |
| **production routes** | production | 3 | 7/7 | 85.7% | 90.5% | 1 | 71.15s | $0.0170 | b1fac38 | `verification_judge_insights_unsupported_vo2max_recency_w15` 1/3 |
| gpt-5.6-luna | high | 5 | 7/7 | 57.1% | 74.3% | 3 | 36.02s | $0.0479 | c015036* (stale) | `verification_judge_insights_hrv_precedes_workout_w32` 4/5<br>`verification_judge_insights_unsupported_vo2max_recency_w15` 1/5<br>`verification_judge_nudge_passes_accurate_week_totals` 1/5 |
| deepseek-v4-pro | high | 5 | 7/7 | 57.1% | 71.4% | 2 | 49.64s | $0.0220 | c015036 (stale) | `verification_judge_insights_invented_drought_length_w32` 3/5<br>`verification_judge_insights_unsupported_vo2max_recency_w15` 0/5<br>`verification_judge_nudge_compound_week_totals_w21` 2/5 |
