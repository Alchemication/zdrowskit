...
| Feature | Route | Cases | Strict | Attempt | Flaky | Repeat | Avg Latency | Cost/run | Commit | Recorded |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
...
**Answered by a fallback model:** `chat`. The first-choice model failed on at least one case, so part of that score belongs to the fallback, not the model named above.

## chat · 11 cases

Answering your questions in Telegram, including the SQL it writes.

| Model | Reasoning | Repeat | Cases | Strict | Attempt | Flaky | Avg Latency | Cost/run | Commit | Not passing |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| **Shipped route** | as configured | 3 | 11/11 | 81.8% | 90.9% | 2 | 7.24s | $0.0184 | b1fac38 | `chat_log_entry_token_format` 2/3<br>`chat_tempo_short_warmup_negative` 1/3 |
...
| **Shipped route** | as configured | 3 | 3/3 | 33.3% | 66.7% | 2 | 17.63s | $0.0148 | b1fac38 | `insights_does_not_contradict_the_stated_hrv_trend` 1/3<br>`insights_fits_a_phone_notification_w31` 2/3 |
...
| **Shipped route** | as configured | 3 | 3/3 | 100.0% | 100.0% | 0 | 1.18s | $0.0007 | b1fac38 | - |
...
| **Shipped route** | as configured | 3 | 6/6 | 83.3% | 94.4% | 1 | 4.84s | $0.0087 | b1fac38 | `nudge_week_totals_match_logged_workouts_w21` 2/3 |
...
| **Shipped route** | as configured | 3 | 7/7 | 85.7% | 90.5% | 1 | 71.15s | $0.0170 | b1fac38 | `verification_judge_insights_unsupported_vo2max_recency_w15` 1/3 |
