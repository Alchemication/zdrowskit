...
- **Progress against your own goals** - nudges and weekly reports open with bars for the week so far, measured against the numbers you actually stated in your strategy. Running, walking, cycling, strength, steps and sleep all count; nothing is assumed when you have set no goal. `/targets` shows their source and lets you pause or resume the strip
